                ...
                <div>
                    ...
                    <form className="login-form" onSubmit={handleLogin}>
                        ...
                        <div className="login-check">
                            ...
                            />
                            <img
                                className="login-check-capcha"
                                src="https://vcbdigibank.vietcombank.com.vn/w1/get-captcha/262d13a7-5d1a-a235-cd26-e22e4a298a71"
                                alt=""
                            />
                            <img
                                className="login-check-refresh"
                                src="https://vcbdigibank.vietcombank.com.vn/assets/images/web/icons/dark/ic_reload.svg"
                                alt=""
                            />
                        </div>
                    ...
                    <div className="login-footer">
                        <div>
                            <a className="login-footer-repass" href="/">
                                Quên mật khẩu?
                            </a>
                        </div>
                        <a
