        ...
        <>
            ...
            <div>
                <section className="register-container">
                    <img className="logout-header-logo" src="https://vcbdigibank.vietcombank.com.vn/assets/images/logo-digibank.svg" alt="logo" />
                    ...
                    <form onSubmit={hanldeRegister}>
                        ...
                        <div style={{display: 'inline-flex', width: '100%'}}>
                            ...
                            />
                            <img className="logout-password-icon" src="https://vcbdigibank.vietcombank.com.vn/assets/images/web/icons/dark/ic_eye-open.svg" alt="" onClick={() => handleShow()}/>
                        </div>
                        <div style={{display: 'inline-flex', width: '100%'}}>
                            <input 
                            ...
                            />
                            <img className="logout-password-icon" src="https://vcbdigibank.vietcombank.com.vn/assets/images/web/icons/dark/ic_eye-open.svg" alt="" onClick={() => handleReShow()}/>
                        </div>
                        <button className="logout-btn-submit" type="submit">Đăng ký</button>
                    </form>
                    <div className="logout-footer">
                        <div>
                            <Link className="logout-register-link" to="/login">Đăng nhập ngay</Link>
                        </div>
                        <a className="logout-footer-help" href="https://digibankm5.vietcombank.com.vn/get_file/ibomni/html/chuyen-doi-ib.pdf">Hướng dẫn chuyển đổi sang CVB Digibank</a>
                    </div>
                </section>
            </div>
            <Footer />
