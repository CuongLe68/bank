...
const authSlice = createSlice({
    ...
    reducers: {
        //Đăng nhập
        loginStart: (state) => { //khi bắt đầu login
        ...
        //Đăng ký
        registerStart: (state) => { //khi bắt đầu đăng ký
            state.register.isFetching = true;
        },
        registerSuccess: (state,action) => { //đăng ký thành công
        ...
        registerFalse: (state) => {
            ...
            alert('Thông tin không hợp lệ hoặc đã tồn tại')
        },
